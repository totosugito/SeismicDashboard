<template>
  <div>
    <ejs-grid :dataSource='data' :allowGrouping='true' :allowFiltering='true' :allowPaging="true" :pageSettings='pageSettings' height='75vh'>
      <e-columns>
<!--        <e-column headerText='Order Status' :template="customerIDHeaderTemplate" width=200></e-column>-->
