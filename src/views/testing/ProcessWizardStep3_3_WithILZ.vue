          ...
          <splitpanes class="default-theme" vertical style="height: 60vh" vertical>
            <pane class="p-2" min-size="20" max-size="80" style="background: ghostwhite">
              <b-form-checkbox
                ...
                class="mb-2">
                Inline, XLine, Z Parameter
              </b-form-checkbox>

              <template v-if="bCheckILZ">
                <div class="mb-2">
                <b-form-textarea
                  id="textarea"
                  v-model="textIXZ"
                  placeholder="[[inline1, xline1, z1], [inline2, xline2, z2], ... ]"
                  rows="3"
                  max-rows="6"/>
                  <b-btn class="btn btn-md mt-1" variant="primary" @click="openProbabilityILZDialog()">Probability</b-btn>
                </div>
              </template>
              <template v-else>
                <div>
