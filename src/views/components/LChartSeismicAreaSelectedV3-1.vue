...
<script>
  import {
    ...
    ColorHEX,
    ColorPalettes,
    ColorRGBA, emptyFill, emptyLine,
    lightningChart, NumericTickStrategy,
    PalettedFill,
    SolidFill,
    SolidLine,
    translatePoint, UIElementBuilders, UIOrigins
  } from '@arction/lcjs'
  import {
    get2dColSize,
    get2dMaxData,
  ...
  export default {
    name: "LChartSeismicAreaSelectedV3-1",
    ...
    methods: {
      ...
      createChart()
      {
        ...
        this.palette = getLcColormapV1(4, this.colormap, this.minData, this.maxData);
        ...
        this.chart.setPadding({bottom: 50})
